...
app.use('/static', express.static('public')); //esto sirve para que el cliente pueda ver publicamente una carpeta con archivos ejemplo url/statatic/img/nombre del alrhivo
